...
module Ts =
    ...
    type [<AllowNullLiteral>] IExports =
        ...
        abstract visitNode: node: 'T * visitor: Visitor option * ?test: (Node -> bool) * ?lift: (ResizeArray<Node> -> 'T) -> 'T when 'T :> Node
        /// <summary>Visits a Node using the supplied visitor, possibly returning a new Node in its place.</summary>
        /// <param name="node">The Node to visit.</param>
        /// <param name="visitor">The callback used to visit the Node.</param>
        /// <param name="test">A callback to execute to verify the Node is valid.</param>
        /// <param name="lift">An optional callback to execute to lift a NodeArray into a valid Node.</param>
        abstract visitNode: node: 'T option * visitor: Visitor option * ?test: (Node -> bool) * ?lift: (ResizeArray<Node> -> 'T) -> 'T option when 'T :> Node
        ...
        abstract visitNodes: nodes: ResizeArray<'T> * visitor: Visitor option * ?test: (Node -> bool) * ?start: float * ?count: float -> ResizeArray<'T> when 'T :> Node
        /// <summary>Visits a NodeArray using the supplied visitor, possibly returning a new NodeArray in its place.</summary>
        /// <param name="nodes">The NodeArray to visit.</param>
        /// <param name="visitor">The callback used to visit a Node.</param>
        /// <param name="test">A node test to execute for each node.</param>
        /// <param name="start">An optional value indicating the starting offset at which to start visiting.</param>
        /// <param name="count">An optional value indicating the maximum number of nodes to visit.</param>
        abstract visitNodes: nodes: ResizeArray<'T> option * visitor: Visitor option * ?test: (Node -> bool) * ?start: float * ?count: float -> ResizeArray<'T> option when 'T :> Node
        ...
        abstract createNodeArray<'T> : ResizeArray<'T> -> bool -> ResizeArray<'T>
        ...
        abstract createKeywordTypeNode<'TKind> : 'TKind -> KeywordTypeNode<'TKind>
    ...
    type [<AllowNullLiteral>] CustomTransformers =
        ...
        abstract afterDeclarations: ResizeArray<U2<TransformerFactory<Bundle>, CustomTransformerFactory>> option with get, set
...
Use typeAcquisition.enable instead.")>]
    ...
    type [<AllowNullLiteral>] NodeFactory =
        ...
        abstract createTrue: unit -> TrueLiteral
        abstract createFalse: unit -> FalseLiteral
        abstract createModifier: kind: ModifierSyntaxKind -> ModifierToken<ModifierSyntaxKind> //when 'T :> ModifierSyntaxKind
        ...
        abstract createKeywordTypeNode: kind: KeywordTypeSyntaxKind -> KeywordTypeNode<KeywordTypeSyntaxKind> // when 'TKind :> KeywordTypeSyntaxKind
        ...
        abstract createAssignment: left: Expression * right: Expression -> AssignmentExpression<AssignmentOperatorToken>
