...
test('typeAlias/tupleType', () => {
    const filePath = path.join(__dirname, '../..//references/typeAlias/tupleType.d.ts');
...
test('typeAlias/interface', () => {
    const filePath = path.join(__dirname, '../..//references/typeAlias/interface.d.ts');
    let result = generateBindingFile(filePath);
    result += `
(***)
#r "nuget: Fable.Core"
