...
test('exclude/literalIntEnum', () => {
    const filePath = path.join(__dirname, '../..//references/exclude/literalIntEnum.d.ts');
...
test('exclude/literalStringEnum', () => {
    const filePath = path.join(__dirname, '../..//references/exclude/literalStringEnum.d.ts');
    let result = generateBindingFile(filePath);
    result += `
(***)
#r "nuget: Fable.Core"
