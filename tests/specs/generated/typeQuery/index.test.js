...
test('typeQuery/class', () => {
    const filePath = path.join(__dirname, '../..//references/typeQuery/class.d.ts');
...
test('typeQuery/defaultToObj', () => {
    const filePath = path.join(__dirname, '../..//references/typeQuery/defaultToObj.d.ts');
    let result = generateBindingFile(filePath);
    result += `
(***)
#r "nuget: Fable.Core"
