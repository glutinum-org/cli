...
test('functionType/simple', () => {
    const filePath = path.join(__dirname, '../..//references/functionType/simple.d.ts');
...
test('functionType/oneGeneric', () => {
    const filePath = path.join(__dirname, '../..//references/functionType/oneGeneric.d.ts');
    let result = generateBindingFile(filePath);
    result += `
(***)
#r "nuget: Fable.Core"
